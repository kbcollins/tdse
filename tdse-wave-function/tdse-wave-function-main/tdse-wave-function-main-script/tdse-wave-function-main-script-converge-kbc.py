...
os.environ['TF_FORCE_GPU_ALLOW_GROWTH']='true'  # this is suppose to fix the cunn convol problem
...
cmprm = np.load(workingdir / 'cmpprm.npy', allow_pickle=True)
print('cmpprm =', cmprm)
...
for i in range(numtrials):
    ...
    # COLLECT THE l2 AND l-inf ERRORS OF THE PROP TEST AND GRAPH RESULTS
