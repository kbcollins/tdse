...
plt.hlines(meanrawl2err + avgdevrawl2err, xvec[0], xvec[-1], linestyles='dashdot', label='_')
plt.hlines(meanrawl2err - avgdevrawl2err, xvec[0], xvec[-1], linestyles='dashdot', label='_')
...
plt.hlines(meanrawlinferr + avgdevrawlinferr, xvec[0], xvec[-1], linestyles='dashdot', label='_')
plt.hlines(meanrawlinferr - avgdevrawlinferr, xvec[0], xvec[-1], linestyles='dashdot', label='_')
...
plt.hlines(meanshiftl2err + avgdevshiftl2err, xvec[0], xvec[-1], linestyles='dashdot', label='_')
plt.hlines(meanshiftl2err - avgdevshiftl2err, xvec[0], xvec[-1], linestyles='dashdot', label='_')
...
plt.hlines(meanshiftlinferr + avgdevshiftlinferr, xvec[0], xvec[-1], linestyles='dashdot', label='_')
plt.hlines(meanshiftlinferr - avgdevshiftlinferr, xvec[0], xvec[-1], linestyles='dashdot', label='_')
...
plt.hlines(meantrimshiftl2err + avgdevtrimshiftl2err, xvec[0], xvec[-1], linestyles='dashdot', label='_')
plt.hlines(meantrimshiftl2err - avgdevtrimshiftl2err, xvec[0], xvec[-1], linestyles='dashdot', label='_')
...
plt.hlines(meantrimshiftlinferr + avgdevtrimshiftlinferr, xvec[0], xvec[-1], linestyles='dashdot', label='_')
plt.hlines(meantrimshiftlinferr - avgdevtrimshiftlinferr, xvec[0], xvec[-1], linestyles='dashdot', label='_')
