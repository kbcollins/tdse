...
print('Average % error of raw learned potential:', np.mean(rawl2err) / vxrange, sep='\n')
...
print('Average % error of shifted learned potential:', np.mean(shiftl2err) / vxrange, sep='\n')
...
print('Average % error of trimmed and shifted learned potential:', np.mean(trimshiftl2err) / vxrange, sep='\n')
...
print('Max % error of raw learned potential:', np.mean(rawlinferr) / vxrange, sep='\n')
...
print('Max % error of shifted learned potential:', np.mean(shiftlinferr) / vxrange, sep='\n')
...
print('Max % error of trimmed and shifted learned potential:', np.mean(trimshiftlinferr) / vxrange, sep='\n')
